...
/**
 * AIBlogCard — renders a structured AI-generated blog article
 * as a premium styled card.
 *
 * Props:
 *   article: { title, introduction, keyPoints[], summary, isDemo }
 *   onNewArticle: () => void  — callback to generate a new article
 */
        ...
        >
            ...
            <div className="ai-blog-card__body">
                ...
                <div className="ai-blog-card__section-title">
                    <span className="ai-blog-card__section-icon">🔑</span>
                    Key Points
                </div>
